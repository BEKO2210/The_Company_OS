  ...
  const cards = [
    {
      ...
      subtitle: totalScore === 0 ? 'Keine Daten' : totalScore > 60 ? 'Hohes Risikoniveau' : totalScore > 30 ? 'Mittleres Risikoniveau' : 'Niedriges Risikoniveau',
      trend: '',
      trendUp: false,
      trendPositive: true,
      color: totalScore === 0 ? 'text-text-tertiary' : totalScore > 60 ? 'text-status-red' : totalScore > 30 ? 'text-status-yellow' : 'text-status-green',
    ...
    },
    {
      ...
      subtitle: criticalCount === 0 ? 'Keine kritischen Risiken' : 'Sofortige Aktion erforderlich',
      trend: '',
      trendUp: true,
      trendPositive: false,
      color: criticalCount === 0 ? 'text-text-tertiary' : 'text-status-red',
    ...
    },
    {
      ...
      subtitle: openIncidents === 0 ? 'Keine Incidents' : 'In Bearbeitung',
      trend: '',
      trendUp: false,
      trendPositive: true,
      color: openIncidents === 0 ? 'text-text-tertiary' : 'text-status-orange',
    ...
    },
    {
      ...
      trendUp: false,
      trendPositive: true,
      color: activeVetos === 0 ? 'text-text-tertiary' : 'text-status-red',
      barPercent: 0,
